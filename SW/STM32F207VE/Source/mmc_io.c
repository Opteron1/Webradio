...
volatile u16 Timer1=0, Timer2=0; //100Hz decrement timer
...
BYTE rcvr_datablock(BYTE *buff, UINT btr)
{
  ...
  Timer1 = 30; //Wait for data packet in timeout of 200ms
  do
  {
    token = rcvr_spi();
...
BYTE send_cmd(BYTE cmd, DWORD arg)
{
  ...
  if(n == 0) DEBUGOUT("send_cmd ERROR\n\r");
