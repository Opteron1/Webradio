...
u16 uuid_test(char *uuid) //uuid: xxxx-xx-xx-xx-xxxxxx
{
  u16 i;
...
void freqtostr(u16 freq, char *freq_str)
{
	...
	if(freq < 1000)
	{
		gbuf.tuner.frequency[0] = buffer[0];
		gbuf.tuner.frequency[1] = buffer[1];
		gbuf.tuner.frequency[2] = '.';
		gbuf.tuner.frequency[3] = buffer[2];
		gbuf.tuner.frequency[4] = ' ';
		gbuf.tuner.frequency[5] = 'M';
		gbuf.tuner.frequency[6] = 'H';
		gbuf.tuner.frequency[7] = 'z';
		gbuf.tuner.frequency[8] = ' ';
	}
	else
	{
		gbuf.tuner.frequency[0] = buffer[0];
		gbuf.tuner.frequency[1] = buffer[1];
		gbuf.tuner.frequency[2] = buffer[2];
		gbuf.tuner.frequency[3] = '.';
		gbuf.tuner.frequency[4] = buffer[3];
		gbuf.tuner.frequency[5] = ' ';
		gbuf.tuner.frequency[6] = 'M';
		gbuf.tuner.frequency[7] = 'H';
		gbuf.tuner.frequency[8] = 'z';
	}
}
